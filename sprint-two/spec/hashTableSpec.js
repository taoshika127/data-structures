describe('hashTable', function() {
  ...
  it('should store more values that were inserted', function() {
    hashTable._insert('Hack', 'Reactor');
    expect(hashTable._retrieve('Hack')).to.equal('Reactor');
    hashTable._insert('Hack', 'Unreactive');
    expect(hashTable._retrieve('Hack')).to.equal('Unreactive');
  });
